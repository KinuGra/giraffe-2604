...
export function CodeBlock({
  ...
  return (
    <div
      className={cn(
        "relative rounded-md border border-border bg-panel-2 group",
        className,
      )}
    >
      <pre className="px-3 py-3 text-[11.5px] font-mono leading-[1.65] overflow-x-auto">
        {/* biome-ignore lint/security/noDangerouslySetInnerHtml: highlight() only processes its own output, no user input */}
